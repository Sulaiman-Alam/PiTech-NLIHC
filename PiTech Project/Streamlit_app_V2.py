...
def build_bill_expander_label(bill, is_selected=False):
...
def render_bill_expander(bill, highlight_terms, context_suffix=""):
    ...
    expander_label = build_bill_expander_label(bill, is_selected=is_selected)
    ...
    with st.expander(expander_label, expanded=False):
        ...
        if ai_result:
            st.markdown("**AI Relevance Assessment**")
...
with left_col:
    ...
    with st.expander(
        ...
        st.caption("Expected AI cost depends on the number of displayed bills scored and the LLM provider used.")
